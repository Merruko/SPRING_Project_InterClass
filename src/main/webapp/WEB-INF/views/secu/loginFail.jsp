      ...
      <div class="col-md-8">
		...
		<form action="/login" method="post">
            ...
            <!-- PASSWORD -->
              ...
              <div class="input-group mb-4">
				   <font color="red">
				        ログインに失敗しました。${requestScope.loginFailMsg}
				   </font>
              </div>
              
            <!-- LOGIN -->
              <div class="input-group mb-2">
                	<!-- spring security 관련, 변경하지 말 것 -->
              ...
              <table>
              	<tr>
              		<td><button type="button" class="btn btn-info btn-link" onclick="location.href='<c:url value="#"/>'" >ID検索</button></td>
              		<td><button type="button" class="btn btn-info btn-link" onclick="location.href='<c:url value="#"/>'" >パスワード検索</button></td>
